<?php
  ...
  if($quotations->row_count === 0 ){
      ...
      foreach($quotations_list as $quotation) {
          ...
          fputcsv($output, array($quotation->quotationDate, $quotation->customerData->firstName,$quotation->customerData->mobile,$quotation->customerData->email,$quotation->customerData->address,$allNotes));
      }
  }
